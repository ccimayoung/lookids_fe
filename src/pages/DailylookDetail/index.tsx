  ...
  return (
    <Container ref={elementRef}>
      <ImageBox>
        ...
        <BottomContent>
          <TagBox>
            {dailylookDetail?.data?.hashTag && dailylookDetail?.data?.hashTag.split('#').slice(1).map((hash, i) => {
      ...
      <ContentBox>
        ...
        <Description>
          {dailylookDetail?.data?.description}
        </Description>
